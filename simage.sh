...
echo ">>> Imaging call"
time mpirun --mca oob tcp singularity exec --bind /share:/share /share/nas/mbowles/dev/casa-6.simg python image.py --polarisation --spectral --robust=${ROBUST[$SLURM_ARRAY_ID]} --vis=$VIS --copy
