...
IMG_MFS_IQUV1=$(sbatch --dependency=afterany:$SPLIT_ID --export=ALL ./image/image_mfs.sh -0.5)
IMG_MFS_IQUV1=${IMG_MFS_IQUV1##* }
IMG_MFS_IQUV2=$(sbatch --dependency=afterany:$IMG_MFS_IQUV1 --export=ALL ./image/image_mfs.sh 0.4)
IMG_MFS_IQUV2=${IMG_MFS_IQUV2##* }

# Channelwise IQUV: 2 briggs weightings
IMG_CHAN_IQUV1=$(sbatch --dependency=afterany:$SPLIT_ID --export=ALL ./image/image_channels.sh -0.5)
